...
- `issues/2026-05-06T195640-test-freeze-generated-artifact-goldens.md`
...
The closed follow-up issues already define the runtime adapter boundary,
reference lookup contract, and audit event shape. The open follow-up issues
remain separate because they require either fixture coverage, CLI output shape,
or runtime semantics work.
