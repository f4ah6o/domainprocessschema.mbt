...
- [ ] validator が `UNKNOWN_STATE` などの固定 diagnostic code を返す
- [ ] runtime の transition / validation failure が structured diagnostics を返す
- [ ] CLI / WASM demo / tests が string 比較ではなく diagnostic shape を前提に扱える
